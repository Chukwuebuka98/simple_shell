...
This is an ALX collaboration project on Shell. The task is to create a simple shell that mimics the Bash shell.
...
$ alias show=ls
$ show
README.md  builtin.c   environ.c  errors1.c  getLine.c  getinfo.c  lists.c   main.c    parser.c   shell.h       string.c   tokenizer.c
_atoi.c    builtin1.c  errors.c   exits.c    getenv.c   history.c  lists1.c  memory.c  realloc.c  shell_loop.c  string1.c  vars.c
exit
